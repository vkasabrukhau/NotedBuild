      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-8">
        <section className="rounded-[2rem] border border-slate-200 bg-white/90 p-8 shadow-[0_24px_80px_rgba(15,23,42,0.10)]">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
            Your profile is saved. Now choose why you are using Notely and pick
            your school so we can shape the rest of onboarding around that.
          </p>
        </section>
          ...
          <article className="rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            {schools.length === 0 ? (
              <p className="mt-3 text-sm leading-6 text-amber-700">
                No schools are in the database yet.
              </p>
            ) : null}
